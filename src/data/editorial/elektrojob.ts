...
const ENTRIES: Record<string, EditorialContent> = {
  ...
  "automatiker-efz::zg": {
    whatDoes:
      "Ein Automatiker EFZ im Kanton Zug verdrahtet, programmiert und nimmt Steuerungs- und Schaltanlagen für Industrie und Gebäudetechnik in Betrieb. Der Tag wechselt zwischen Werkstattarbeit, SPS-Programmierung auf gängigen Automationsplattformen und Inbetriebnahmen direkt beim Kunden. Im Kanton Zug prägen Hightech-Standorte, Pharmazulieferer und Maschinenbaubetriebe das Auftragsportfolio: Packstrassen, Reinraumtechnik und Prozessleitsysteme. Daneben gehört die Gebäudeautomation für Bürotürme und Logistikzentren zum Standardgeschäft. Wer Schemata sauber liest, Fehler systematisch sucht und mit englischsprachigen Lieferanten kommuniziert, hat in Zug überdurchschnittliche Aufstiegschancen.",
    salary:
      "Automatiker EFZ verdienen im Kanton Zug CHF 75'000 bis 95'000 pro Jahr — am oberen Schweizer Durchschnitt. Mit Erfahrung auf gängigen SPS-Plattformen, IEC-61131-3-Programmierung und Inbetriebnahmeroutine verschiebt sich der Marktwert ins obere Drittel. Spezialisierungen auf Robotik, Antriebstechnik oder Industrie 4.0 / OPC-UA-Vernetzung bringen Zulagen von 8 bis 15 Prozent. Der Aufstieg zum Automationsingenieur (HF/FH berufsbegleitend, 3 bis 4 Jahre) öffnet das Band CHF 100'000 bis 130'000. Pharma- und Hightech-Arbeitgeber im Kanton Zug zahlen oft marktführend, dafür wird auch internationale Inbetriebnahmebereitschaft erwartet. Die Lohnübersicht steht auf der Startseite.",
    employers:
