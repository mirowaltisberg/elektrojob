...
import type { EditorialContent } from "@/data/editorial/elektrojob";
import { EDITORIAL_BYLINE } from "@/data/editorial/elektrojob";

interface EditorialIntroProps {
  /** Display label for the role, e.g. "Elektroinstallateur EFZ" */
  role: string;
