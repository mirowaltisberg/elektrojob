...
export default function DatenschutzPage() {
 return <div className="min-h-screen bg-slate-50"><main className="mx-auto max-w-3xl px-4 py-10 space-y-6">
  ...
  <section className="space-y-3"><h2 className="text-xl font-semibold">Deine Bewerbung</h2><p>Name, Stellen-ID und ein PDF-Lebenslauf werden für die interne Prüfung durch das Plattformteam gespeichert. Für Rückfragen nutzt das Team die im CV angegebenen Kontaktdaten. Eine automatische Weiterleitung an einen Arbeitgeber erfolgt nicht.</p><p>Die Einwilligung wird mit Zeitpunkt dokumentiert. Unterlagen liegen in einem privaten Speicherbereich. Zur Begrenzung wiederholter Anfragen wird ein serverseitig geschützter Hash der IP-Adresse gespeichert, keine IP-Adresse im Klartext. Nach 90 Tagen ist eine Löschprüfung vorgesehen; die tatsächliche Löschung erfolgt durch den Betriebsprozess.</p></section>
